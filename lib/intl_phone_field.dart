...
class IntlPhoneFormField extends FormField<PhoneNumber> {
  /// The TextFormField key.
  final GlobalKey<FormFieldState>? formFieldKey;
  ...
  IntlPhoneFormField({
    ...
    this.flagsButtonMargin = EdgeInsets.zero,
    this.magnifierConfiguration,
  })  : assert(initialNumber == null || controller == null),
        super(
          key: key,
          validator: validator,
          initialValue: controller != null
              ? PhoneNumber.fromCompleteNumber(completeNumber: controller.text)
              : PhoneNumber.fromCompleteNumber(
                  completeNumber: initialNumber ?? ''),
            ...
            return IntlPhoneField(
              ...
              onCountryChanged: (value) {
                state.didChange(PhoneNumber(
                    ...
                    countryCode: "+${value.dialCode}${value.regionCode}",
